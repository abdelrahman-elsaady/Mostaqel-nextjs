...
//   const handlePaymentSuccess = async (paymentData) => {
//     try {
//       const response = await axios.post(`http://localhost:3344/users/${userId}`, {
//         totalBalance: user.totalBalance + parseFloat(depositAmount),
//       });
//       if (response.status === 200) {
//         setUser({ ...user, totalBalance: response.data.totalBalance });
//         handleClose();
...
//           <Modal.Title>شحن الرصيد</Modal.Title>
//         </Modal.Header>
//         <Modal.Body>
//           <Form>
//             <Form.Group className="mb-3">
//               <Form.Label>المبلغ المراد إيداعه</Form.Label>
//               <InputGroup>
...
//             <Form.Group className="mb-3">
//               <Form.Label>المبلغ النهائي بعد إضافة رسوم إجرائية بنسبة 2.75% على عملية الدفع</Form.Label>
//               <Form.Control
//                 type="text"
//                 value={`$${calculateFinalAmount()}`}
//                 readOnly
